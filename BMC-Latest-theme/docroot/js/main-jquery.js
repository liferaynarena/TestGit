...
function onAfterSlide(prevSlide, currentSlide)
{
	...
	$("#" + $(currentSlide).attr("id") + "_content").fadeIn(2000, function(){
...
{
	var expando = $(this).get(0)[jQuery.expando];
	$(".slider_" + expando + "_content_container .slider_content").fadeOut(2000);
...
jQuery(document).ready(function($){
	...
	$(".our_clinic1,.our_clinic2,.our_clinic3,.our_clinic4,.our_clinic5,.our_clinic6").carouFredSel({
		direction: "left",
		items: {
			visible: 3
		},
	...
	$(".our_clinic1").trigger("configuration", {
		prev: '#our_clinic_prev1',
		next: '#our_clinic_next1'
	});
	$(".our_clinic2").trigger("configuration", {
		prev: '#our_clinic_prev2',
		next: '#our_clinic_next2'
	});
	
	$(".our_clinic3").trigger("configuration", {
		prev: '#our_clinic_prev3',
		next: '#our_clinic_next3'
	});
	$(".our_clinic4").trigger("configuration", {
		prev: '#our_clinic_prev4',
		next: '#our_clinic_next4'
	});
	$(".our_clinic5").trigger("configuration", {
		prev: '#our_clinic_prev5',
		next: '#our_clinic_next5'
	});
	$(".our_clinic6").trigger("configuration", {
		prev: '#our_clinic_prev6',
		next: '#our_clinic_next6'
	});
	...
	$(".accordion.wide").bind("accordionchange", function(event, ui){
		$("html, body").animate({scrollTop: $("#"+$(ui.newHeader).attr("id")).offset().top}, 1000);
	});
	$(".tabs").bind("tabsbeforeactivate", function(event, ui){
		$("html, body").animate({scrollTop: $("#"+$(ui.newTab).children("a").attr("id")).offset().top}, 1000);
	});
	$(".tabs").tabs({
		event: 'change',
		show: true,
	...
	$(".gallery_box").hover(function(){
		...
		currentControls.animate({"top": (height/2-currentControlsHeight/2) + "px"},2000,'easeInOutCubic');		
	},function(){
		currentControls.stop();
		currentControls.css("display", "block");
		var height = $(this).find("img").first().height();
		currentControls.animate({"top": (height) + "px"},2000,'easeInOutCubic', function(){
			$(this).css("display","none");
		});
	});
	...
	$(window).bind("hashchange", function(event){
		...
		{
			$(".gallery_item_details_list").animate({height:'0'},{duration:2000,easing:'easeOutQuint', complete:function(){
				$(this).css("display", "none")
		...
		else if(location.hash.substr(1,15)=="gallery-details")
		{
			...
			if(!visible)
			{
				$(".gallery_item_details_list").css("display", "block").animate({height:detailsBlock.height()}, 2000, 'easeOutQuint', function(){
					$(this).css("height", "100%");
					$(location.hash + " .image_carousel").trigger("updateSizesCustom");
				});
				galleryItemDetailsOffset = $(".gallery_item_details_list").offset();
				$("html, body").animate({scrollTop: galleryItemDetailsOffset.top-10}, 2000);
			}
			else
			{
